function X = grassmann_karcher_mean(A)
% Computes a Karcher mean on grassmann manifold.
%
% function X = grassmann_karcher_mean(A)
%
% Input:  A 3D matrix A of size nxpxm such that each slice A(:,:,k) is a
%         point on grassmann manifold of size nxp.
% 
% Output: A orithogonal matrix X of size nxp which is a Karcher mean
