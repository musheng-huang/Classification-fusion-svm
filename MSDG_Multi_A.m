...
% �Ȳ����й�һ��
% 1. Domain A data
load([datapath,'CWRU_A_Features.mat'],'Features','Features_Normal4T','Labels');
TrainS1 = Features;
LabelS1 = Labels;
A=Features;
...
TrainS1 = mapminmax('apply',TrainS1,PS);
...
% % %             mmd_XY5=my_mmd(mapped_TestData,mapped_trainT',R);
           values=Untitled5(mmd_XY1,mmd_XY2,mmd_XY3,mmd_XY4,0.05);
